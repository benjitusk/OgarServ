...
GameServer.prototype.onAdminSocketOpen = function (ws, upgradeReq) {
    ws.isConnected = true;
    ...
    Logger.warn("\u001B[32mRCon connected " + ws.remoteAddress + ":" + ws.remotePort + " [origin: \"" + upgradeReq.headers.origin + "\"]");
    var self = this;
...
GameServer.prototype.onClientSocketOpen = function (ws, upgradeReq) {
    ...
    if (upgradeReq.headers.origin == 'http://agar.io') {
    ...
    if (!upgradeReq.headers['user-agent']) {
        ...
        console.log(JSON.stringify(upgradeReq.headers));
    }
